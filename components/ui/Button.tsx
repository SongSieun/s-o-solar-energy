...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        "bg-primary-500 text-neutral-900 hover:bg-primary-400 focus-visible:ring-primary-500 shadow-sm hover:shadow",
      secondary:
        "bg-neutral-800 text-white hover:bg-neutral-700 focus-visible:ring-neutral-500",
      outline:
        "border-2 border-neutral-300 text-neutral-700 hover:border-neutral-400 hover:bg-neutral-50 focus-visible:ring-neutral-500",
      ghost:
